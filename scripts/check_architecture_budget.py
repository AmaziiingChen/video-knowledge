...
KNOWN_DEBT_BUDGETS = {
    "frontend/src/composables/useAppController.js": 3_835,
    ...
    "backend/services/wechat_publishing.py": 1_627,
    "backend/routers/content.py": 201,
    "backend/services/wechat_subscription.py": 1_640,
    "backend/services/creator_sync.py": 985,
    "frontend/src/features/assistant/SecondarySidebar.vue": 1_743,
    "backend/services/knowledge_v2.py": 1_581,
    "backend/services/campus_digest_generation.py": 1_748,
    "backend/services/campus_sources.py": 1_529,
    "backend/services/pipeline_runner.py": 1_460,
