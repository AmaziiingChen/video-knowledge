...
export function useAppController() {
  ...
  const {
    ...
    generatingSummaryReasoning, generatingSummaryReasoningExpanded,
    startingNewChat,
    lastQaSaved,
    ensureQaSession,
    isQaSessionActive,
  ...
  const {
    ...
    pipelineGeneratingSummaryReasoning, pipelineGeneratingSummaryReasoningTruncated, pipelineSummaryTaskId,
    currentInsightReasoning, currentInsightReasoningTruncated, currentQaEnabled,
    currentQaHint,
  ...
  return {
    ...
    pipelineGeneratingSummaryText,
    pipelineGeneratingSummaryReasoning, pipelineGeneratingSummaryReasoningTruncated, pipelineSummaryTaskId,
    currentInsightReasoning, currentInsightReasoningTruncated, currentQaEnabled, currentQaHint,
    canGenerateAiSummary,
    currentObsidianPath,
    totalElapsed,
    hasTaskProgress,
